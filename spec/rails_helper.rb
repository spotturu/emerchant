MerchantsController
  GET index
    assigns all merchants as @merchants
  GET show
    assigns the requested merchant as @merchant
  GET new
  ...
  DELETE destroy
    ...
    redirects to the widgets list# This file is copied to spec/ when you run 'rails generate rspec:install'
require 'spec_helper'
ENV['RAILS_ENV'] ||= 'test'
